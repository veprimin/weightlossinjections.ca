  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
        {/* Breadcrumb */}
        <nav className="text-sm text-black mb-8" aria-label="Breadcrumb">
        ...
        <h1
          className="text-3xl sm:text-4xl font-bold text-black mb-3 leading-tight"
          style={{ fontFamily: "var(--font-playfair, Georgia, serif)" }}
        >
          Disclaimer, Disclosures &amp; Editorial Standards
        </h1>
        <p className="text-black text-sm mb-10">Last updated: May 18, 2026</p>
        ...
        <div className="prose-editorial space-y-10">
          ...
          <section id="editorial">
            ...
            <ul className="list-disc list-inside text-black space-y-1 mb-4 text-sm">
