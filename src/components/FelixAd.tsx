  ...
  return (
    ...
    >
      <div className="flex-1">
        <p className="font-semibold text-white mb-1">Find out if you qualify for GLP-1 treatment</p>
        <p className="text-sm text-white/70">Felix matches you with a licensed Canadian provider in minutes — no clinic visit needed.</p>
      </div>
      <a
        href={FELIX_LINK}
        target="_blank"
